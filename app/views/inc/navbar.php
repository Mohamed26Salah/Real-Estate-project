    ...
    <header class="site-navbar shadow p-4 mb-4 bg-white" style="position: relative; background-color: white; " role="banner">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="d-inline-block d-xl-none ml-md-0 mr-auto py-3" style="position: relative; top: 3px;"><a href="#" class="site-menu-toggle js-menu-toggle " style="text-decoration: none; color:black;"><span class="icon-menu h3"></span></a></div>

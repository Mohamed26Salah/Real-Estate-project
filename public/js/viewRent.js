...
var obj = [
  { number: '<!-- single card start --><div class="product-card-Rent"><div class="priority"></div><!-- begin visible button --><div class="product-details"><h4><div class="arabic">اسم صاحب العقار : محمد </div><div class="arabic">اسم المستأجر : يوسف </div></h4><div class="product-bottom-details"><div class="product-price">$230.99</div><!-- timer start --><p id="demo">10 days</p><!-- timer end --></div></div><div class="row" style="justify-content:center; margin-top:-15%"><div class="priority high">high</div><div class="codeblock">A50</div></div></div><!-- single card end --><!-- divider start --><div class="h-divider"><div class="shadow"></div><div class="text"><i>High</i></div></div><!-- divider end -->'},
